...
import com.alcanl.app.stream.handler.StreamServerHandler;
import com.alcanl.app.stream.handler.StreamServerListener;
...
public class StreamServerChannelPipelineFactory implements ChannelPipelineFactory{
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		//comment the netty's frame encoder if you want to use the build in h264 encoder
		...
		//for which we may need to server so many clients, so we need to move this out of the pipeline
