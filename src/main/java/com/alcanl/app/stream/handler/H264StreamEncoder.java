...
import com.alcanl.app.stream.handler.frame.FrameEncoder;
...
public class H264StreamEncoder extends OneToOneEncoder{
	...
	private void initialize(){
		...
		//rate
 		...
 		codecOptions.setValue("tune", "zero latency");// equals -tune zero latency in ffmpeg
 		//open it
	...
	public Object encode(Object msg) throws Exception {
		...
		if (!(msg instanceof BufferedImage)) {
			throw new IllegalArgumentException("your need to pass into an buffered-image");
		}
