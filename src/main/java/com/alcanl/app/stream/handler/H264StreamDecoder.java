...
import com.alcanl.app.stream.handler.frame.FrameDecoder;
...
public class H264StreamDecoder extends OneToOneDecoder {
	...
	/**
	 * Cause there may be one or more image in the frame,so we need a Stream listener here to get
	 * all the image
	 *
	...
	private void initialize() {
		...
		// iStreamCoder.setFlag(IStreamCoder.Flags.FLAG_SCALE, true);
